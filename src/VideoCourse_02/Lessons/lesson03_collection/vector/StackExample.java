...
// Stack - устаревший класс (является подклассом Vector), не рекомендуется к использованию
public class StackExample {
    public static void main(String[] args) {
        ...
        while (!stack.isEmpty()) {//если не выполнить проверку, а стек пуст, и вызвать метод pop(), то вылетит Exception
