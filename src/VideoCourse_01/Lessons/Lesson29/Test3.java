...
public class Test3 {
    public static void main(String[] args) {
        ...
        si.testStudents(list, (Student3 st) -> {return st.avgGrade > 8.5;});        // вариант 1 - запись лямбда-выражения
        System.out.println("-------------------------------------------------");
        si.testStudents(list, (Student3 st) -> st.avgGrade < 9);                    // вариант 2 - запись лямбда-выражения
        System.out.println("-------------------------------------------------");
        si.testStudents(list, st -> st.age > 25);                                   // вариант 3 - запись лямбда-выражения
        System.out.println("-------------------------------------------------");
        si.testStudents(list, st -> {return st.age < 27;});                         // еще 1 вариант записи лямбда-выражения
        System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++");
        si.testStudents(list, st -> {int z = 5; return st.age < 27;});              // еще 1 вариант записи лямбда-выражения
